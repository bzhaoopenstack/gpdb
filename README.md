...
**Zuul Regression Test**[![Zuul Regression Test](http://openlabtesting.org:15000/badge?project=greenplum-db%2Fgpdb&job_name=test-check-api)](https://status.openlabtesting.org/builds/builds?project=greenplum-db%2Fgpdb&job_name=gpdb-installcheck-world-tests-on-arm64)
----------------------------------------------------------------------
